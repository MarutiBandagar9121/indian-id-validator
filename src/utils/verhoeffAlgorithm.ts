...
// converts string to an array and inverts it
function invArray(array: string[]): number[] {
  return array.map(Number).reverse();
}

// generates checksum
function generate(array:string[]):string {
...
function verhoeffValidation(aadhaarString:string):boolean {
